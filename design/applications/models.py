...
class Application(models.Model):
    ...
    image_admin = models.ImageField(verbose_name="Фотография дизайна", upload_to='images_admin/',
                                    validators=[FileExtensionValidator(allowed_extensions=['png', 'jpg', 'jpeg', 'bmp'])],
                                    help_text="Указать фото дизайна при смене статуса на 'Выполнено'")

    comment_admin = models.TextField(verbose_name="Комментарий", help_text="Указать комментарий при смене статуса на 'Принята в работу'")
